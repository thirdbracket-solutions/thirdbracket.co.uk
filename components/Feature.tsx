    ...
    <section className="py-16 sm:py-24 lg:py-28 ">
      <div className="space-y-8 ">
        ...
        <div className="flex flex-col lg:flex-row items-center  justify-center  gap-4   ">
          <h2 className="max-w-4xl   lg:max-w-6xl text-[1.65rem]/[2rem] md:text-3xl   font-black  lg:text-right text-center bg-gradient-to-r  from-gray-800 via-gray-900 to-gray-800 dark:from-gray-200 dark:via-gray-100 dark:to-gray-200 text-transparent bg-clip-text ">
            Think Your Business Can’t Afford a&nbsp;Professional&nbsp;Start?
          </h2>

          <p className="text-base md:text-xl  lg:text-left text-gray-800/70 dark:text-gray-200/40 max-w-2xl  lg:max-w-4xl text-center ">
