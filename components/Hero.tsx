...
const Hero = () => {
  ...
  bg-[size:14px_24px]"
      >
        <h1 className="text-[40px]/[1.1] sm:text-5xl/[1.2] lg:text-6xl/[1.2] font-black text-center max-w-3xl sm:max-w-4xl lg:max-w-6xl px-4 bg-gradient-to-r from-gray-800 via-gray-900 to-gray-800 dark:from-gray-200 dark:via-gray-100 dark:to-gray-200 text-transparent bg-clip-text">
          Enterprise Solutions, Minus the Overhead Cost
        </h1>

        <p className="bg-white dark:bg-gray-950 text-base/7 lg:text-lg/8 text-center text-gray-800/70 dark:text-gray-200/40 max-w-2xl sm:max-w-3xl lg:max-w-4xl px-4 ">
